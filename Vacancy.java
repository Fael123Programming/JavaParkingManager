...
public class Vacancy {
    ...
    public String toString(){
        return String.format("-------------------------------------------"
                + "----------------------------------------------------------"
                + "\nCliente\n%s\nAutomóvel\n%s\nHorário de chegada: %s%nTempo de estacionamento: %s%nTotal "
                + "a pagar: R$ %.2f",this.
                        customer,this.customersAuto,this.arrivalTime,this.calculateTotalTime(),
                        this.calculatePrice(this.hourPrice));
    }
}
